...
const multiSelectVariants = cva('m-1', {
  variants: {
    variant: {
      default: 'border-input bg-card text-foreground hover:bg-card/80',
      secondary:
  ...
  (
    ...
    return (
      ...
      >
              ...
              <div className="flex w-full items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Separator
                    ...
                    className="flex h-full min-h-6 opacity-50"
                  />
                  <Icon
                    name="ChevronDown"
                    className="ml-2 mr-1 h-4 cursor-pointer opacity-50"
                  />
                </div>
              </div>
            ) : (
        ...
        >
          <Command>
            <CommandInput placeholder="検索" onKeyDown={handleInputKeyDown} />
            <CommandList>
              <CommandEmpty>一致するデータがありません</CommandEmpty>
              <CommandGroup>
                <CommandItem
                  key="all"
                  onSelect={toggleAll}
